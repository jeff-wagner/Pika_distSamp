...
###      Step 1: Data Management - Observation Data           ###

###############################################################-#

# This script imports, explores, and processes distance sampling observations of pika for use in 
# abundance analysis with unmarked.
