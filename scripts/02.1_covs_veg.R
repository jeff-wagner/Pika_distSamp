...
###                Step 2.2: Vegetation Data                  ###

###############################################################-#

# This script wrangles the data from the site info datasheet and the 10x10m vegetation plots that were 
# conducted at each site. We are interested in categorizing the dominant vegetation types around the talus
...
siteDesc <- read_excel(path = paste(getwd(),"/data/2018_and_2019_SiteInfo.11.8.2019.xlsx", sep = ""), 
