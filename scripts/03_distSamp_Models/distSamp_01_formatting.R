...
###    Step 3: Distance Sampling - Formatting for Unmarked    ###

###############################################################-#

# This script imports and explores the cleaned distance sampling and covariate data and formats it for analysis 
# with unmarked. The unmarked package requires the data to be packaged a certain way before we can build models.

# Read in the observation and covariate data from our data management scripts.
source("scripts/01_dataSurveys/data_01_Observations.r")
source("scripts/02_dataCovariates/covs_02_CompileCovariates.r")
